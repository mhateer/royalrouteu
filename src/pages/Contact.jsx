  ...
  return (
    <div style={{ padding: '40px 20px 80px' }}>
      <div className="container">
        ...
        {/* MOBILE FIX: Changed minmax(350px) to minmax(280px) */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px' }}>
            ...
            <div className="glass-panel" style={{ padding: '30px' }}>
              ...
              <div style={{ display: 'flex', gap: '20px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '1.1rem' }}>Business Atrium Building,<br />Oud Metha, Dubai, UAE</div>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            style={{ padding: '30px' }} // Slightly reduced padding for mobile
          >
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: '20px' }}>
                ...
                <input type="tel" name="phone" placeholder="Mobile" required style={inputStyle} onChange={handleChange} />
              </div>
